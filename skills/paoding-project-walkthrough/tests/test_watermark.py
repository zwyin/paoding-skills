...
class TestBuildWatermarkSection:
    def test_zh_default(self):
        html = build_watermark_section("paoding-project-walkthrough", "https://github.com/zwyin/paoding-skills", "zh")
        assert 'id="ch-watermark"' in html
        assert "关于本报告" in html
        assert "<strong>paoding-project-walkthrough</strong>" in html
        assert "https://github.com/zwyin/paoding-skills" in html
...
class TestWatermarkCLI:
    ...
    def test_default_tool_name_matches_skill_name(self, docs_dir, tmp_path):
        ...
        skill_dir = parts[-3]  # e.g. "paoding-project-walkthrough"
