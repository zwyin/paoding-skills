...
SKILL_MD = ROOT / "skills" / "paoding-project-walkthrough/SKILL.md"
CURSOR_FILE = ROOT / "cursor" / "paoding-project-walkthrough.mdc"
WINDSURF_FILE = ROOT / ".windsurf" / "rules" / "paoding-project-walkthrough.md"
OPENCODE_FILE = ROOT / ".opencode" / "skills" / "paoding-project-walkthrough" / "SKILL.md"
...
class TestOpenCodeFile:
    ...
    def test_frontmatter_has_name(self):
        ...
        assert fm.get("name") == "paoding-project-walkthrough"
