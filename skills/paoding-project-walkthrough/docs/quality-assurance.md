...
| L5 | 端到端验证 | 从 `/paoding-project-walkthrough` 调用到最终产出的完整流程 | 发版前 |
...
| `skills/paoding-project-walkthrough/SKILL.md` | YAML frontmatter：`name`、`description`、`argument-hint` |
...
# 3. 验证 skill 可用
/paoding-project-walkthrough --help    # 应显示 argument-hint

# 4. 实际生成 walkthrough
/paoding-project-walkthrough /path/to/some/project --depth brief
