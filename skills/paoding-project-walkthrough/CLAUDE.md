...
版本号定义在 `skills/paoding-project-walkthrough/SKILL.md` frontmatter 的 `version` 字段。**所有其他位置的版本号必须从这里同步，不允许手动分别修改。**

### 版本号出现位置（6 处）

| # | 文件 | 位置 | 说明 |
|---|------|------|------|
| 1 | `skills/paoding-project-walkthrough/SKILL.md` | frontmatter `version: "X.Y.Z"` | **唯一版本源**，手动修改 |
| 2 | `skills/paoding-project-walkthrough/SKILL.md` | `--version` flag 文档 + Phase 0 启动横幅 | `paoding-project-walkthrough vX.Y.Z`（2 处）、`> **Version X.Y.Z**`（1 处，Phase 0 横幅） |
...
1. **修改版本源**：编辑 `skills/paoding-project-walkthrough/SKILL.md` frontmatter 的 `version` 字段
...
grep '^version:' skills/paoding-project-walkthrough/SKILL.md

# 位置 2: --version 输出文本（2处）
grep 'paoding-project-walkthrough v' skills/paoding-project-walkthrough/SKILL.md
...
- **SKILL.md 是单一事实源**：`skills/paoding-project-walkthrough/SKILL.md` 是所有平台文件的源头
