...
[![CI](https://github.com/zwyin/paoding-skills/actions/workflows/test.yml/badge.svg)](https://github.com/zwyin/paoding-skills/actions/workflows/test.yml)
...
[← 返回 paoding-skills 合集](https://github.com/zwyin/paoding-skills#readme)
...
claude --plugin-dir ./paoding-skills  # 保留完整目录结构，路径引用不会断裂
```
...
```
/paoding-project-walkthrough /path/to/project --depth deep --audience dev
```
...
/paoding-project-walkthrough --depth all                                  # All depths + general + zh (CWD)
/paoding-project-walkthrough /path/to/project --lang en                   # Brief + general + en
/paoding-project-walkthrough /path/to/project --depth deep --no-confirm    # Deep + 跳过确认门
/paoding-project-walkthrough /path/to/project --lang zh-pure               # Brief + general + 纯中文
/paoding-project-walkthrough /path/to/project --lang bilingual             # Brief + general + 中英对照
/paoding-project-walkthrough --version                                    # 显示版本号
```
