...
版本号定义在 `skills/paoding-github-safe-publish/SKILL.md` frontmatter 的 `version` 字段。

### 版本号出现位置（6 处）

| # | 文件 | 位置 | 说明 |
|---|------|------|------|
| 1 | `skills/paoding-github-safe-publish/SKILL.md` | frontmatter `version: "X.Y.Z"` | **唯一版本源** |
...
- **SKILL.md 是唯一事实源**：所有扫描规则、步骤流程、修复逻辑都定义在 `skills/paoding-github-safe-publish/SKILL.md` 中
...
- **已发布**：https://github.com/zwyin/paoding-skills
