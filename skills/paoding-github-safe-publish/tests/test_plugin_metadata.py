...
SKILL_MD = ROOT / "skills" / "paoding-github-safe-publish" / "SKILL.md"
...
def test_plugin_json_name_matches_skill():
    data = _load_json(PLUGIN_JSON)
    assert data["name"] == "paoding-github-safe-publish"
...
def test_marketplace_json_has_plugins():
    ...
    assert plugins[0]["name"] == "paoding-github-safe-publish"
